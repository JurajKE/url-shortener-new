...
public final class AppConstants {
    ...
    public static final String HELP_PAGE = "HOW TO INSTALL \n \n\n 1. Run mvc clean package to create executable JAR file \n\n " +
            ...
            "4. For shortening of URL please use /register endpoint which will return short version of URL \n\n " +
            ...
            "6. If shortUrl is called, statistics are incremented and there are available at /statistics ";
